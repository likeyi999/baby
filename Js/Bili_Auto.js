...
async function SwitchRegion(title, url, body) {
	const Group = $.read('BiliArea_Policy') || '𝐁𝐢𝐥𝐢𝐛𝐢𝐥𝐢'; //Your blibli policy group name.
	...
	const DF = $.read('BiliArea_DF') || '𝐓𝐖'; //Sub-policy name used after region is blocked(e.g. url 404)
